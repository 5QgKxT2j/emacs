...
(defun mell-paragraph-string (&optional point)
  (buffer-substring (mell-point-at-bop point) (mell-point-at-eop 
point)))
...
(defun mell-call-function-region-or-string (function &optional 
args-list)
  (apply function
...
(defun mell-call-function-region-or-paragraph (function &optional 
args-list)
...
(defun mell-narrow-to-transient-region (&optional begin end)
  ...
  (setq begin (or begin (and (transient-region-active-p) 
(region-beginning)))
...
(defun mell-region-get-rectangle-marker-list (start end &optional 
buffer)
  (mapcar
   '(lambda (region)
      (cons (mell-marker-make (car region)) (mell-marker-make (cdr 
region)))
      )
